	...
	elseif($jumlah_page > 5 ) /*Jika Page lebih dari 5*/
	{
		...
		<ul>
			...
			<?php 
				...
				{
					echo "<meta http-equiv='refresh' content='0;url={$selectartikel}'>";
				}
